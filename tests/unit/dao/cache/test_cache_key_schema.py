...
def test_appconfig_latest_key(keys):
    """Ensure appconfig_latest_key() generates correct pointer key."""
...
@pytest.mark.parametrize(
    ...
    [
        ('cloudshortener:dev', 3,
         ...
         'cloudshortener:dev:appconfig:v3',
         'cloudshortener:dev:appconfig:v3:metadata'),
        ('testprefix', 10,
         'testprefix:appconfig:latest',
         'testprefix:appconfig:v10',
         'testprefix:appconfig:v10:metadata'),
        (None, 5,
         'appconfig:latest',
         'appconfig:v5',
