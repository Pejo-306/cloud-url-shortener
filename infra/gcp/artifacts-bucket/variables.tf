variable "project_id" {
  type        = string
  description = "Project that will own the artifacts bucket (often an org admin / shared project)."
}
...
variable "bucket_name" {
  type        = string
  description = "Base name for the GCS artifacts bucket. The project number is appended automatically for global uniqueness."
