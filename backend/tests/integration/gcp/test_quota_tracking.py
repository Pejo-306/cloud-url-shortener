...
from tests.integration.gcp.schemas import redis_key_schema


class TestQuotaTracking:
    def test_user_creation_quota_tracking(self, infra: Infrastructure):
    ...
    def test_link_hit_quota_tracking(self, infra: Infrastructure, project: GcpProject, data_stores: DataStores):
        # 0. Authenticate with Identity Platform
        ...
        target_url = 'https://http.cat/405'
        key_schema = redis_key_schema(project)
        ...
        with infra.identity_platform.authenticate() as id_token:
            ...
            short_url = infra.backend.api.redirect_url(shortcode)
